...
exports.calc = function(wundergroundKey, inputDate, pws, canopyReflectionCoefficient, callback, fail) {
  ...
  async.waterfall([
    ...
    function(obj, callback) {
      ...
      var minTemp = Number(obj.history.dailysummary[0].mintempm);
      var maxTemp = Number(obj.history.dailysummary[0].maxtempm);
      var meanTemp = Number(obj.history.dailysummary[0].meantempm);
...
function evapotranspiractionCalc(maxTempF, minTempF, meanSolarRadiationW, avgWindSpeedMPH, elevationFt, maxHumidity, minHumidity,latitudeDegrees,canopyReflectionCoefficient, day, data) {
